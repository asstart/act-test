...
![data_hierarchy](mongodb_data_hierarchy.png)
...
![mongodb_methodology](mongodb_methodology.png)
...
![flexible_methodology.png](flexible_methodology.png)

### Identifying the workload

List of operations

![example_identifying_ops.png](example_identifying_ops.png)

Operation details

![example_op_details.png](example_op_details.png)
![example_op_read_details.png](example_op_read_details.png)

Operation importance

![example_op_importace.png](example_op_importace.png)

Summary

![example_op_info_summary.png](example_op_info_summary.png)
...
![1_t_N_embed_many_side.png](1_t_N_embed_many_side.png)

- embed many-side entities to one-side entities
![1_t_N_embed_one_side.png](1_t_N_embed_one_side.png)
...
![1_t_N_link_one_side.png](1_t_N_link_one_side.png)

- link in the many-side entities
![1_t_N_link_many_side.png](1_t_N_link_many_side.png)

Usually linking in the main side entities

### Many-to-many

![N_t_M_exmp.png](N_t_M_exmp.png)

1. Embed

- array of subdocuments in the many-side
![N_t_M_embed.png](N_t_M_embed.png)
...
![N_t_M_link_main_side.png](N_t_M_link_main_side.png)

- array of references in the other many-side
![N_t_M_link_secondary_side.png](N_t_M_link_secondary_side.png)
...
> ![zillions_notation.png](zillions_notation.png)
...
![duplication_is_solution.png](duplication_is_solution.png)
...
![dupl_min_effect.png](dupl_min_effect.png)
...
Pattern description
![attr_patter_summary.png](attr_patter_summary.png)
...
![attr_pattern_product_example.png](attr_pattern_product_example.png)
...
![attr_pattern_film_releases_example.png](attr_pattern_film_releases_example.png)

### Extended reference pattern

Pattern description
![ext_ref_pattern_summary.png](ext_ref_pattern_summary.png)
...
![ext_ref_example.png](ext_ref_example.png)

### Subset pattern

Pattern description
![ubset_pattern_summary.png](subset_pattern_summary.png)
...
![compute_pattern_summary.png](compute_pattern_summary.png)

### Bucket pattern

![bucket_pattern_summary.png](bucket_pattern_summary.png)
...
![bucket_by_day_exmpl.png](bucket_by_day_exmpl.png)
Or  
By device by houre
![bucket_by_hour_example.png](bucket_by_hour_example.png)
...
![schema_version_pattern_summary.png](schema_version_pattern_summary.png)
...
![tree_pattern_summary.png](tree_pattern_summary.png)
...
![polymorph_pattern_summary.png](polymorph_pattern_summary.png)

### Approxymation pattern

![aprox_pattern_summary.png](aprox_pattern_summary.png)

### Outliers pattern

![outlires_pattern_summary.png](outlires_pattern_summary.png)

### Patterns summary

![patterns_summary.png](patterns_summary.png)